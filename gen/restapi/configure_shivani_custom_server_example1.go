...
//go:generate swagger generate server --target ..\..\gen --name ShivaniCustomServerExample1 --spec ..\..\swagger\swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.ShivaniCustomServerExample1API) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ShivaniCustomServerExample1API) http.Handler {
